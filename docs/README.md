...
| 3 | [`decisions/`](decisions/) | **ADR-SC-0005~0019** — 되돌리면 안 되는 결정. 0001~0004 는 폐기 |
...
flowchart TB
  subgraph NOW["🟢 현재 — v3.0 섹터 ETF 레이더 (2026-09-11~)"]
    ...
    D["docs/decisions/0005~0019<br/>ADR 14건 · 0009 결번"]
...
| 폴더 | 상태 | 무엇 | 커밋 |
|---|---|---|---|
| [`decisions/`](decisions/) | 🟢 **현재** | ADR 18건(0001~0019 · 0009 결번). 참조 키는 `ADR-SC-NNNN` | ✅ |
