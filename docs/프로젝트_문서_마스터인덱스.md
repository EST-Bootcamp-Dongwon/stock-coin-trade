...
| 3 | [`decisions/`](decisions/) | ADR-SC-0005~0018 — 되돌리면 안 되는 결정 |
...
| **결정 기록 (ADR)** | ✅ 0005~0018 · 13건 (0009 결번) | [`decisions/`](decisions/) |
| **백로그** | ✅ | [`backlog/`](backlog/) |
...
flowchart TB
  ...
  subgraph DOCS["docs/ — 결정과 배경"]
    ...
    DE["decisions/ 0005~0018<br/>되돌리면 안 되는 결정"]
...
| — | 09-20 | 이슈 **#15 · #13** — 가중치 0 축의 «기여 없음» (ADR 0014 ③-1) · 기여합과 총점의 **잔차** (ADR 0018). 1002→**1014건** |
