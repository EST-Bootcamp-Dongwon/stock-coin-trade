...
| 3 | [`decisions/`](decisions/) | ADR-SC-0005~0016 — 되돌리면 안 되는 결정 |
...
| **결정 기록 (ADR)** | ✅ 0005~0016 · 12건 | [`decisions/`](decisions/) |
| **백로그** | ✅ | [`backlog/`](backlog/) |
...
flowchart TB
  ...
  subgraph DOCS["docs/ — 결정과 배경"]
    ...
    DE["decisions/ 0005~0016<br/>되돌리면 안 되는 결정"]
...
| [`backlog/issues/`](backlog/issues/) | ⬜ **아직 GitLab 에 못 올린 이슈 본문 3건** — 스팸 필터에 막혔다. 한 번에 하나씩 올린다 |
